  ...
  return (
    <div className="space-y-6 animate-in fade-in slide-in-from-bottom-4 duration-500">
      <div className="bg-white rounded-3xl p-6 md:p-8 shadow-sm border border-[#1B1B5E]/5 text-center">
        ...
        <h2 className="text-3xl font-black text-[#1B1B5E] uppercase tracking-tighter mb-2">Policies & Terms</h2>
        <p className="text-[#1B1B5E]/60 font-medium max-w-md mx-auto mb-8">
          Review our Return Policy, Privacy Policy, and Terms of Service.
        </p>
