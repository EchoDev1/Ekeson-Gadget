    ...
    <div className="min-h-screen bg-[#F7F3E9] pt-32 pb-20">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-4xl">
        ...
        <div className="text-center mb-16">
          <div className="w-24 h-24 bg-white text-[#00AEEF] rounded-full flex items-center justify-center mx-auto mb-6 shadow-2xl border border-[#1B1B5E]/5">
        ...
        <div className="bg-white rounded-[3rem] p-8 md:p-16 shadow-xl border border-[#1B1B5E]/5 relative">
          <div className="absolute top-12 left-12 w-20 h-20 bg-[#00AEEF]/5 rounded-full blur-2xl" />
          <div className="absolute bottom-12 right-12 w-32 h-32 bg-[#1B1B5E]/5 rounded-full blur-3xl" />
          ...
          <div className="relative z-10 prose prose-lg prose-blue max-w-none">
            {loading ? (
              ...
              <div className="text-[#1B1B5E]/80 whitespace-pre-wrap font-medium leading-relaxed text-lg">
